    ...
    return (
      ...
      <Hero />
        <div className='container'>
          ...
          <div className='row row-content align-items-center 3types'>
          ...
          <div className='row row-content align-items-center'>
            ...
            <img className='col-6' src='img/sake_hero5.jpg' alt='dog stares at sake' />
          </div>

          <div className='row row-content align-items-center'>
            <div className='col-6'>
              <img src='img/sake_box.jpg' width='90%' alt='sake box' />
            </div>
            <div className='col-6'>
